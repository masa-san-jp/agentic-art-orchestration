...
# Gates run from a fresh archive with no warm bytecode. Measured on 2026-08-20:
# agentic-art-production 100s, agentic-art-research 49s warm and over 60s cold.
# A cap below those turns a passing suite into a reported gate failure, which is
# the same as saying the child repository is broken when it is not.
