...
alias.  It is safe to canonicalize that one OS-owned alias, while caller
created symlinks remain rejected.  Keeping this rule in one module prevents
each entrypoint from making a different path-safety decision.
"""
