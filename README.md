...
Source updated at: `2026-09-12T03:46:20+09:00`.
...
Next action: Reauthenticate the configured opencode provider, then run resume/new-clone/fork twice each from the README default entry; do not promote probes or synthetic history to AC11.
Ready: none.
Next task: `null`.
Blocked:
- `AP-06`: EXTERNAL_AGENT_AUTHENTICATION: reauthenticate the configured opencode provider and rerun the acceptance manifest.
