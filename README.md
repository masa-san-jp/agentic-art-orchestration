...
Source updated at: `2026-09-14T17:34:44+09:00`.

| BACKLOG | READY | IN_PROGRESS | BLOCKED | DONE | Total |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 3 | 0 | 0 | 2 | 188 | 193 |

Current task: `OI-08`; repository: `agentic-art-project`; checkpoint: `OI-10`.
Next action: Read back the owner validator failure for P0004 and obtain explicit attribution/rights evidence or an owner-approved canonical re-projection before resuming the Project receiver task.
Ready: none.
Next task: `null`.
Blocked:
- `OI-08`: Project origin/mainの既存P0004にattestation未記載のJPEGと帰属不明状態があり、owner validatorがunlisted public media/PLAN_NOT_CANONICALで失敗する。削除、validator弱体化、権利・creator・同意の捏造では解消できない。
